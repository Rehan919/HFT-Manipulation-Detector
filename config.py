...
class LiveMarketConfig:
    ...
    min_score_interval_seconds: float = float(os.getenv("LIVE_MIN_SCORE_INTERVAL_SECONDS", "0.25"))
...
class SecondaryLiveConfig:
    ...
    min_score_interval_seconds: float = float(
        os.getenv("SECONDARY_LIVE_MIN_SCORE_INTERVAL_SECONDS", "0.25")
    )
